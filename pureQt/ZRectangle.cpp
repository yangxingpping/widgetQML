...
ZRectangle::ZRectangle(QQuickItem* parent) : QQuickPaintedItem(parent){
    color(QColor(255,255,255,255));
    radius({0,0,0,0});
    connect(this,&ZRectangle::colorChanged,this,[=]{update();});
    connect(this,&ZRectangle::radiusChanged,this,[=]{update();});
}

void ZRectangle::paint(QPainter* painter){
    painter->save();
